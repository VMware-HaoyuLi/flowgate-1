...
public class VCDataServiceTest {
   ...
   public void testQueryHostMetaData() throws Exception {
      ...
      doReturn(true).when(service).feedHostMetaData(any(), any(), any());
      doReturn(true).when(service).feedClusterMetaData(any(), any(), any(), any(), any());
   ...
   public void testFeedHostMetaData() {
      ...
      boolean needUpdate = service.feedHostMetaData(hostInfo, host, hostInfo);
   ...
   public void testFeedClusterMetaData() {
      ...
      boolean needUpdate =
            service.feedClusterMetaData(clusterMap, hostInfo, host, esxiMetadata, hostInfo);
      TestCase.assertEquals(needUpdate, true);
   }
}
